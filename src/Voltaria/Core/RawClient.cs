...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Voltaria.Core.ApiResponse> SendRequestAsync(
        global::Voltaria.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Voltaria.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::Voltaria.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::Voltaria.Core.BaseRequest request)
    {
