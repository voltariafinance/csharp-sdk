...
public class InvestorGetLoanTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v2/investors/loans/loan_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Investors.InvestorGetLoanAsync(
            new InvestorGetLoanRequest { LoanId = "loan_id" }
        );
