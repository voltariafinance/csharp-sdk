...
public class InvestorListLoansTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock.RequestBuilders.Request.Create().WithPath("/v2/investors/loans").UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Investors.InvestorListLoansAsync(
