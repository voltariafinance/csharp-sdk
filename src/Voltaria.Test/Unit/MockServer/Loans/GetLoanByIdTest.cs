...
public class GetLoanByIdTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock.RequestBuilders.Request.Create().WithPath("/v2/loans/loan_id").UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Loans.GetLoanByIdAsync(
            new GetLoanByIdRequest { LoanId = "loan_id" }
        );
