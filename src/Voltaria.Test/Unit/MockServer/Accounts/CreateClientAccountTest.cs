...
public class CreateClientAccountTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Accounts.CreateClientAccountAsync(
            new PartnerClientAccountCreateRequest
            {
                ClientId = "client_id",
                AccountHolderName = "account_holder_name",
                Label = null,
                AccountHolderType = AccountHolderTypeEnum.Private,
