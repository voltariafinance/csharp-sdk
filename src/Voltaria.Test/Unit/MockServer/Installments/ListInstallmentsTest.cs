...
public class ListInstallmentsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock.RequestBuilders.Request.Create().WithPath("/v2/installments").UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Installments.ListInstallmentsAsync(
