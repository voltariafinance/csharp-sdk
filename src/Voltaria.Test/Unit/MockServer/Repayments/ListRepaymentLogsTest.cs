...
public class ListRepaymentLogsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(WireMock.RequestBuilders.Request.Create().WithPath("/v2/repayments").UsingGet())
            .RespondWith(
                WireMock
        ...
        var response = await Client.Repayments.ListRepaymentLogsAsync(
