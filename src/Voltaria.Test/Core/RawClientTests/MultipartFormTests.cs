...
namespace Voltaria.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Voltaria.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Voltaria.Core.MultipartFormRequest
        {
